    ...
    <div class="bg-[#202020] border-1 p-6 w-full max-w-lg rounded-xl border-white shadow-xl">
      ...
      <form method="POST" action="{{ route('admin.store-client') }}">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="nama_perusahaan" name="nama_perusahaan" placeholder="Masukkan nama perusahaan"
      ...
      @enderror
        ...
        <div class="mb-4">
          ...
          <input type="email" id="email" name="email" placeholder="Masukkan email perusahaan"
            class="w-full p-2 bg-gray-600 text-white placeholder:text-gray-300 outline-none focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg">
          @error('email')
        <div class="text-red-500 text-sm">{{ $message }}</div>
      @enderror
        ...
        <div class="mb-4">
          ...
          <input type="text" id="no_telepon" name="no_telepon" placeholder="Masukkan nomor telepon perusahaan"
            class="w-full p-2 bg-gray-600 text-white placeholder:text-gray-300 outline-none focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg">
          @error('no_telepon')
        <div class="text-red-500 text-sm">{{ $message }}</div>
      @enderror
