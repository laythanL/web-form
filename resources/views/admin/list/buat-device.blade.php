...
<body class="bg-gray-600">
  ...
  <div class="flex items-center justify-center min-h-screen">
    <div class="bg-[#202020] border-1 p-6 w-full max-w-2xl rounded-xl border-white shadow-xl">
      <h1 class="text-white text-center text-xl mb-2 font-semibold ">tambahkan data device </h1>
      @if(session('success'))
      <div class="bg-green-100 text-green-700 p-2 rounded mb-4">
      {{ session('success') }}
      </div>
    @endif
      <form method="POST" action="{{route('admin.store-device')}}">
        @csrf
      ...
      @enderror
          ...
          {{-- Assigned To --}}
          <div class="col-span-2">
            <label for="assigned_to" class="block mb-1 font-semibold text-white">Ditugaskan ke</label>
